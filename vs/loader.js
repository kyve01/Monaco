        ...
        o = function() {
            ...
            return t.prototype._init = function(e) {
                ...
                t.prototype._initNodeRequire = function(t, r) {
                    ...
                    return d.runInThisContext(i).call(e.global, t.getGlobalAMDRequireFunc(), t.getGlobalAMDDefineFunc(), n, this._path.dirname(r)), s.record(32, r), d
...
! function(e) {
    ...
    var r = function() {
        function t(e, t, r, n, o, i) {
            this.id = e, this.strId = t, this.dependencies = r,
                this._callback = n, this._errorback = o, this.moduleIdResolver = i, this.exports = {}, this.exportsPassedIn = !1, this.unresolvedDependenciesCount = this.dependencies.length, this._isComplete = !1
        }
...
! function(e) {
    ...
    s.config = i, s.getConfig = function() {
        ...
        "function" == typeof e.global.define && e.global.define.amd || (n = new e.ModuleManager(r, e.createScriptLoader(r), o, s, e.Utilities.getHighPerformanceTimestamp()), void 0 !== e.global.require && "function" != typeof e.global.require && s.config(e.global.require), (define = function() {
